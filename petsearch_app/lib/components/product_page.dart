  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserModel>(
        ...
        builder: (context, snapshot) {
          ...
          String name = '';
          Widget profilePicture = Icon(CupertinoIcons.person);
          if (snapshot.hasData) {
            currentUser = snapshot.data;
            name = currentUser.firstName + " " + currentUser.lastName;
            profilePicture =
                Image.network(currentUser.profilePath, fit: BoxFit.cover);
          } else {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Description', style: gradientText(20)),
                          SizedBox(
                            height: 10,
                          ),
                          Padding(
                          ...
                          Text('Details', style: gradientText(20)),
                          SizedBox(
                            height: 10,
                          ),
                          Padding(
